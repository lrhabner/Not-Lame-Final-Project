...
### Logan Habner
Logan is a junior at the University of Washington in the Electrical Engineering Major. He went to a basketball game once ten years ago. His next closest experience is playing the Hoops game mode in Rocket League.
...
The age data comes from players' birthdays.
The salary data comes from players' contracts.
The twitter data comes from players' social statistics.
...
Players with **higher salaries** have a **larger twitter following** in general. 

Players who are **relatively young** and **relatively old** have a **smaller twitter following** in general.

Outliers include:
  **Stephen Curry** who took a pay cut to help his team (less pay than expected)
  **Pau Gasol** who is popular in Spain (more followers than expected)
  **Dirk Nowitzki** who was a respected veteran star (higher pay than expected)
